...
|:---------|:---------------|:------------------------------------------------|
|1.|Write a C program to check if a given number is Fibonacci number.|https://github.com/Savio0703/DSA/blob/6893dc7deb8dafe724222656f5cde6495a2f6c89/Savio%20(Fibonacci%20number).c|
|2.|Write a C program to generate Pascal Triangle using array.|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Savio%20(Pascal%20triangle).c|
|3.|Write a C program to roll_no, name , percentange of 5 students using array of structure and display the records in ascending order of roll list.|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Savio%20(asc%20order).c|
|4.|Write a C program to roll_no, name , percentange of 5 students using array of structure and display the records in descending order of roll list.|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Savio%20(descending).c|
|5.|Write a C program to find largest element in an array |https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Savio%20(largest%20element).c|
|6.|Write a menu driven program to perform the following operations in an ARRAY 1. INSERT2. DELETE 3. TRAVERSE 4. SEARCH |https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/menu_driven.c|
|7.|Define a structure data type called time_struct containing 3 members int hour, int|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Prog3.c|
...
|8.|Write a function that compares two arrays and returns 1 if they are identical and 0 otherwise.|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Prog4.c|


## DSA program list B :-
|Program_Id| Program details|Your File nameHyperlink to the .c file on github|
|----------|----------------|-------------------------------------------------|
|1.|Write a menu driven program to implement list ADT using SINGLE LINKEDLIST and (https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/LinkedListImplementation.c)|
...
||13. SPLIT||
||14. REVERSE||
|4.|Write a menu driven program to implement list ADT using CIRCULAR DOUBLE|https://github.com/Savio0703/DSA/blob/82aa8c942b56c446de7d357c71f7ee0533662fee/Circular_double_LinkedList.c|
