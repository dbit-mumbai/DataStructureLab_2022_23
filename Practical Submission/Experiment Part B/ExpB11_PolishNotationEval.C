/*
	...
	ROLL NO.      : 43
	PROGRAM NAME  : POLISH NOTATIONS
*/

//To evaluate a given infix expression into postfix.
...
//remove the commented print statements in push, pop, n1 and n2 to see how the calculation actually
//occurs
