...
|:---------|:---------------|:------------------------------------------------|
|1.|Write a C program to check if a given number is Fibonacci number.|https://github.com/marctheexplorer/DSA2/blob/37f90ee827b19a2d2e6be09f3bc7ef000db8fd8b/Marc_17(FIBONACCI%20NO).c|
|2.|Write a C program to generate Pascal Triangle using array.|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Marc_17(PASCAL%20TRIANGLE).c|
|3.|Write a C program to roll_no, name , percentange of 5 students using array of structure and display the records in ascending order of roll list.|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Marc_17(ASCENDING).c|
|4.|Write a C program to roll_no, name , percentange of 5 students using array of structure and display the records in descending order of roll list.|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Marc_17(DESCENDING).c|
|5.|Write a C program to find largest element in an array |https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Marc_17(LARGEST%20ELEMENT).c|
|6.|Write a menu driven program to perform the following operations in an ARRAY 1. INSERT2. DELETE 3. TRAVERSE 4. SEARCH |https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/menu_driven.c|
|7.|Define a structure data type called time_struct containing 3 members int hour, int|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Prog3.c|
...
|8.|Write a function that compares two arrays and returns 1 if they are identical and 0 otherwise.|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Prog4.c|


## DSA program list B :-
|Program_Id| Program details|Your File nameHyperlink to the .c file on github|
|----------|----------------|-------------------------------------------------|
|1.|Write a menu driven program to implement list ADT using SINGLE LINKEDLIST and (https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/LinkedListImplementation.c)|
...
||13. SPLIT||
||14. REVERSE||
|4.|Write a menu driven program to implement list ADT using CIRCULAR DOUBLE|https://github.com/marctheexplorer/DSA2/blob/3576873d6c4ecc361346593701a708eae4b94a22/Circular_double_LinkedList.c|
